...
global.dfail = (type, m, conn) => {
    let msg = {
        rowner: 'ONLY _*OWWNER!1!1!*_',
        owner: '*Lu Owner Kah Deck ?🗿*',
        mods: 'Fitur Khusus _*Moderator*_ !',
        premium: 'Fitur Khusus _*Premium*_ members!',
        group: '_Khusus Di Dalam Group !_',
        private: '_Khusus Private Message !_',
        admin: '_Hanya Dapat di Gunakan Oleh_ *Admin* group!',
        botAdmin: '_Jadikan Bot Sebagai Admin Untuk Menggunakan Fitur Ini_ *Admin* to use this command!',
